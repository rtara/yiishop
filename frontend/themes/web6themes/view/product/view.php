...
//                                echo "<img src=\"{$image->getUrl('150x150')}\" class=\"thumb\" />";
                                $img = $image->getUrl('800x800');
                                echo Html::tag('li',
                                        Html::tag('div',
                                            Html::img($img, ['data-imagezoom' => 'true', 'class' => 'img-responsive']),
                                        ['class' => 'thumb-image']),
                                    ['data-thumb' => $img]);
                            }
                        } else {
...
?>
			...
			<div class="col-md-8 single-right">
				...
				<div class="simpleCart_shelfItem item_single">
                    <p>
                        <?php
...
<!--    --><?//= \frontend\components\widgets\RelatedProd::widget(['model' => $model]) ; ?>
	...
	<div class="w3l_related_products">
		<div class="container">
            ...
            <?= \frontend\components\widgets\MyListView::widget([
                'dataProvider' => $dataProvider,
                'itemView' =>  '@app/themes/web6themes/view/category/_product',
                'options' => [
